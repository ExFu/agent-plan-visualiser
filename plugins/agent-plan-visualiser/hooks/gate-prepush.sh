...
#
# Install:  bash plugins/agent-plan-visualiser/scripts/install-gate.sh
...
resolve_gate_check() {
  ...
  if [ -f "plugins/agent-plan-visualiser/scripts/gate-check.sh" ]; then
    echo "plugins/agent-plan-visualiser/scripts/gate-check.sh"
    return 0
  fi
