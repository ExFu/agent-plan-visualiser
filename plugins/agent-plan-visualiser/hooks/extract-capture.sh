...
#
# Install:  bash plugins/agent-plan-visualiser/scripts/install-extractor.sh
...
resolve_extractor() {
  ...
  if [ -f "plugins/agent-plan-visualiser/scripts/extract-commit.py" ]; then
    echo "plugins/agent-plan-visualiser/scripts/extract-commit.py"; return 0
  fi
