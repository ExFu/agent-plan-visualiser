# Project state — generated 2026-07-07T14:10:15Z

**Total events:** 484  ·  **Draft:** 13  ·  **Live:** 10  ·  **Dormant:** 0  ·  **Closed:** 52  ·  **Orphaned:** 0
...
- **T2-packaging**
  - `T3-distribution` (14 events): verification.deferred → entity.progressed → verification.tested
...
- `T2-ingest` (authored 2026-05-23, 75 commit(s) ago)
