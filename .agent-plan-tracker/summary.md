# Project state — generated 2026-05-27T19:03:41Z
...
- **(T2 itself)**
  - `T2-analyser` (8 events): entity.progressed → entity.progressed → entity.progressed
...
- **(milestone)**
  ...
  - `M6-analyser` (6 events): entity.progressed → entity.progressed → entity.progressed
