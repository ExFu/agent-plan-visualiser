...
- **(T2 itself)**
  - `T2-analyser` (7 events): entity.progressed → entity.progressed → entity.progressed
...
- **(milestone)**
  ...
  - `M6-analyser` (5 events): entity.progressed → entity.progressed → entity.progressed
...
- **T2-analyser**
  - `T3-analyser-phase-d-cascade-invalidation` (2 events): entity.created → relationship.spawns
...
- **M6-analyser**
  - `T3-analyser-phase-d-cascade-invalidation`
...
- **M6-analyser**: 3/4 T3 complete (75%); 1 live
