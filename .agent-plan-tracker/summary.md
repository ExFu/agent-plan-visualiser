# Project state — generated 2026-07-10T12:40:35Z

**Total events:** 521  ·  **Draft:** 13  ·  **Live:** 10  ·  **Dormant:** 0  ·  **Closed:** 53  ·  **Orphaned:** 0
...
- **(milestone)**
  ...
  - `M5-backfill` (14 events): verification.tested → entity.progressed → verification.tested

- **T2-packaging**
  - `T3-distribution` (29 events): verification.tested → entity.progressed → verification.tested
...
- `T2-ingest` (authored 2026-05-23, 87 commit(s) ago)
