...
- The plugin's `skills/using-agent-plan-tracker/SKILL.md` (when written) leads with Why agents need the methodology, then How they use the tracker, then What commands/scripts are available.
