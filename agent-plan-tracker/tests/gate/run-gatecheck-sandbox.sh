...
# /apt-merge landing. Fresh repo: the hook gates main from its first commit.
...
echo "== ref-update: APT_SKIP_GATE hatch works; reset back to green flows"
run env APT_SKIP_GATE=1 git merge wip
