...
python3 agent-plan-tracker/scripts/backfill/backfill.py \
...
# Adjust paths so the agent-plan-tracker scripts find the right files
# (until M4 packaging, you'll invoke them with explicit paths)
python3 /path/to/agent-plan-tracker/agent-plan-tracker/scripts/cache-build.py
python3 /path/to/agent-plan-tracker/agent-plan-tracker/scripts/projection-emit.py
python3 /path/to/agent-plan-tracker/agent-plan-tracker/scripts/summary-emit.py
